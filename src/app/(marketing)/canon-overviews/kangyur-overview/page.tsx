...
const BlogPost05 = () => {
    return (
        <div className="bg-primary">
            ...
            <div className="mx-auto w-full flex flex-col gap-6 px-8 pt-8 pb-12 md:pt-12 md:pb-16 bg-linear-to-b from-brand-50 from-0% via-brand-100 via-30% to-brand-200 to-100% dark:bg-linear-to-b dark:from-brand-800/50 dark:from-0% dark:via-brand-800/30 dark:via-30% dark:to-brand-900/90">
                ...
                <div className="flex w-full flex-col justify-between md:flex-row">
                    <div className="flex flex-1 flex-col max-w-280 pr-4 md:pr-24">
                        ...
                        <p className="mt-1 text-base text-tertiary md:mt-2 md:text-lg text-balance">
                            Explore the historical evolution of the Kangyur in Tibet. This timeline traces the development of the scriptural fundations of the Kangyur corpora across different periods and the people that influenced them.
                        </p>
                    </div>
