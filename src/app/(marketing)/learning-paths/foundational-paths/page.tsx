...
export default function FoundationalPathsOverviewPage() {
    return (
        <>
            {/* Hero Section */}
            <section className="relative flex flex-col items-center justify-center gap-4 mx-auto h-[calc(100vh)] bg-[url(/monk-seated-in-meditation-under-forest-tree-1920.webp)] bg-cover bg-center bg-no-repeat pt-16">
