...
export default function AcademicPathsPage() {
    return (
        <>
            {/* Hero Section */}
            <section className="relative flex flex-col items-center justify-center gap-4 mx-auto h-[calc(100vh)] bg-[url(/ancient-nalanda-university-idealization.jpg)] bg-cover bg-center bg-no-repeat pt-16">
