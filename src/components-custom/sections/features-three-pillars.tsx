                ...
                <div className="grid grid-cols-1 gap-10 md:gap-20 lg:grid-cols-2 lg:gap-24">
                    <div className="max-w-xl flex-1 self-center">
                        ...
                        <p className="mt-2 text-md text-tertiary md:mt-4 md:text-lg">
                            Buddhist sources were scattered and fragmented for centuries. Grounded on three decades of digital advancements, we've made access to Buddha's heritage a joyful and functional experience, fostering your intrinsic motivation to:
                        </p>
